export const timetableData: any = {
	'101': {
		'2026-05-11': {
			'6': {
				teacher: '박혜리',
...
// 2-4 금요일 2교시 음악A: 이윤경 → 전태상 (참관 기간 모든 금요일). 이윤경 선생님의 음악A 수업을 전태상 선생님이 그대로 진행.
...
// 5/26(화) 교시 교환 2건 추가: 2-3 3교시↔7교시(주지원 체육B ↔ 노유리 도덕), 2-5 5교시↔7교시(김일홍 수학 ↔ 주지원 체육B).
...
> = {
	...
	'203': {
		...
		'2026-05-26': {
			...
			'3': { teacher: '노유리', subject: '도덕' },
			'7': { teacher: '주지원', subject: '체육B' }
		}
	},
	'201': {
		'2026-05-20': {
	...
	'205': {
		'2026-05-26': {
			'5': { teacher: '주지원', subject: '체육B' },
			'7': { teacher: '김일홍', subject: '수학' }
		}
	},
	'206': {
		'2026-05-20': {
